...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 23 2023 г., 18:36
...
CREATE TABLE `product` (
  ...
  `decsription` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `amount` int NOT NULL,
  `cost` int NOT NULL,
...
INSERT INTO `product` (`id_product`, `name`, `photo_product`, `decsription`, `amount`, `cost`, `id_seller`) VALUES
(4, 'Кофе Jacobs', '309d3d87-10bf-492d-8ac3-b39efca69cd3.jpg', 'В 1895 году знаток кофе Йохан Якобс открыл свою первую кофейную фабрику – Jacobs Coffee Roastery. Йохан привозил людям кофе в зёрнах самого высокого качества. Он вложил всю свою страсть и мастерство обжарки кофейных зёрен в создание бленда, который раскрывал всё богатство вкуса и аромата кофе. Сохраняя традиции отбора кофейных зёрен самого высокого качества и мастерства обжарки с 1895 года, Jacobs Monarch и сегодня дарит богатый насыщенный вкус и аромат кофе его ценителям.', 1000, 400, 2);
...
(1, 4, '57576576539', 'results-1.xlsx', '378374374334', '2023-06-23');
...
(4, 'Данил', 'Махмутов', 'default-user-pic.png', '727727', '89961038964', 'test3@mail.ru', 2);
